...
export default function CustomerDashboard() {
    ...
    // Query langsung ke pickup_orders — tidak perlu join tabel lain
                        ...
                        <div className="divide-y divide-gray-50 overflow-y-auto max-h-64">
                            ...
                            {!ordersLoading && recentOrders.map((order) => (
                                <div key={order.id} className="flex items-center justify-between px-5 py-3.5">
                                    <div className="flex items-center gap-3">
                                        {/* Tampilkan foto produk jika ada, fallback ke emoji */}
                                        <div className="w-9 h-9 rounded-full bg-[#f3f4f6] flex items-center justify-center shrink-0 overflow-hidden">
